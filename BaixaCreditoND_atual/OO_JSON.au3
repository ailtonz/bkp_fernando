...
;~ Global $dirFile 	 = @ScriptDir & "\Includes\"
Global $dirFile 	 = @ScriptDir & "\"
Global $FileJson 	 = $dirFile & "json2.txt"
Global $FileJsonpath = $dirFile & "jsonpath-0.8.0.js"
Global $FileKeys 	 = $dirFile & "Keys_polyfill.txt"

$json_text = _OO_JSON_Read_File($FileJson)
$jsonPath_text = _OO_JSON_Read_File($FileJsonpath)
$Objectkeys_polyfill_text = _OO_JSON_Read_File($FileKeys) ; scripting object dosen't have a keys function.
