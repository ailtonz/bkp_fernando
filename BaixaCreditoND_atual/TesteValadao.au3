...
Local $Print = "C:\Users\wesley.valadao\Documents\BaixaCreditoND\CONTAS ATYLS.jpg"
...
Local $Teste =  "/vision/v1.0/Analyze"

Global $token = "9b59945e11fe421e87d9dcd83a8c4d5d"

;Local  $jsonToSendSTR =

Local $arrList = apiCall($sHttpServ,$Teste,"POST",$Text,$token,$eTech,1,"","")
ConsoleWrite($arrList)
